-- 🚨 CRITICAL DATABASE SETUP SCRIPT
...
-- =============================================
-- STEP 2: CREATE STUDENTS TABLE (if not exists)
-- =============================================
...
INSERT INTO auth.users (
  ...
  '{"name":"Admin 1","role":"ADMIN","department":"CSE"}',
  false,
  '',
  '',
  '',
...
INSERT INTO auth.users (
  ...
  NOW(),
  '{"provider":"email","providers":["email"]}',
  '{"name":"Admin 2","role":"ADMIN","department":"CSE"}',
  false,
  '',
  '',
  '',
...
INSERT INTO auth.users (
  ...
  NOW(),
  '{"provider":"email","providers":["email"]}',
  '{"name":"Admin 3","role":"ADMIN","department":"CSE"}',
  false,
  '',
  '',
  '',
...
SELECT 'Students in students table:' as info;
SELECT id, name, email, department, role FROM students;
